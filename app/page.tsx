  ...
  return (
    <div>
      <meta
        ...
        content="MSUVmcbKfJXbo9LdJIxFVAE9yCsROgxazl10DETeE-w"
      />
      ...
      >
        ...
        <div className="max-w-[1300px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6 md:px-12">
          ...
          <div className="bg-white shadow-md rounded-2xl p-8 text-center hover:shadow-xl transition-shadow duration-300 flex flex-col h-full">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              La transformation de vos contenus audio ou vidéo en un texte clair
              et structuré. Que ce soit pour du sous-titrage ou de la
              transcription, je veille à la fidélité des propos, à la lisibilité
